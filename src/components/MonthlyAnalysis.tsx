...
const MONTHLY_SECTIONS: MonthlySection[] = [
  {
    ...
    icon: '🔥',
    score: 76,
    headline: '35 curated topics + 8 daily Claude-synthesized topics from HN signals — Reddit channel still missing',
    wins: [
  ...
  },
  {
    ...
    icon: '👥',
    score: 75,
    headline: '58 communities tracked with strong APAC additions, but Chinese ecosystem still partial',
    wins: [
      'APAC coverage materially improved — 8 communities added (ROS Japan, Korea Robotics Society, Robotics India, Singapore AI & Robotics, Unitree Dev Forum, DJI Developer Forum, Japan DLA Robotics SIG, Australia Open Robotics)',
      'Open-source communities now well represented — LeRobot, MuJoCo, Drake, Yocto all in the tracked set',
  ...
  },
  {
    ...
    icon: '📅',
    score: 80,
    headline: '50 events + 30 meetups & hackathons tracked with sponsor recommendations — pipeline still manual',
    wins: [
      '80 total events in the system: 50 conferences + 30 meetups/hackathons',
      'Sponsor recommendation flag (yes/maybe/no) on every meetup with one-line rationale — 12 flagged "yes" for Q2-Q3 sponsorship',
  ...
  },
  {
    ...
    icon: '🎤',
    score: 74,
    headline: '45 speakers tracked across academia, industry, and Europe — Rising Talent watchlist now active',
    wins: [
      '15 new speakers added — 10 robotics-company practitioners (Covariant, Apptronik, 1X, Figure AI, Boston Dynamics, Agility) plus 5 European researchers (ETH Zurich RSL, TU Munich, IIT Genova, Oxford Robotics, TU Delft)',
      'Rising Talent watchlist live — 8 high-growth researchers tagged with paper count + social growth %',
  ...
  },
  {
    ...
    icon: '💬',
    score: 78,
    headline: '43 channels tracked including the official NVIDIA Omniverse Discord (38.5K members) and 5 Chinese-robotics servers',
    wins: [
      'NVIDIA Omniverse Discord now in the data set — 5 channels (#general, #isaac-sim, #openusd, #cosmos, #digital-twins), 38.5K members, ~10K weekly messages combined',
      '5 Chinese-robotics Discords added (Unitree, DJI Dev, RoboMaster, CyberDog, Chinese Physical AI Forum) — first real signal into that ecosystem',
      'Topic clusters tagged automatically: OpenUSD, Digital Twin, Foundation Models, Vision AI',
    ],
    gaps: [
      'Still observer-mode in non-NVIDIA channels — no posting schedule or community engagement plan',
      'No alerting system for negative NVIDIA mentions — we would only see them in retrospect',
  ...
  },
  {
    ...
    icon: '⭐',
    score: 64,
    headline: '50 influencers tracked across micro/macro/top tiers — outreach workflow still entirely manual',
    wins: [
      'Roster expanded 32 → 50 with stronger global representation — 4 APAC, 3 European, 2 LATAM/MENA, plus dedicated OpenUSD and CAE specialist personas',
      'Tier filter live (Micro <25K / Macro 25–100K / Top 100K+) — supports balanced amplification strategy',
      'shouldEngage flag set on 28 of 50 — clear prioritization already done',
    ],
    gaps: [
      'Outreach has not started — tracked list is still pure inventory, not workflow',
      'No follower-growth tracking — Twitter/X paywall blocks programmatic auto-refresh',
      'No connection between influencers and the papers / repos they actually engage with',
    ],
    actions: [
  ...
  },
  {
    ...
    icon: '🎬',
    score: 70,
    headline: 'Live YouTube auto-refresh active — 16 channels, ~150 videos/week pulled automatically',
    wins: [
      'YouTube auto-refresh wired — 16 verified channels resolving cleanly (NVIDIA Developer/Omniverse, ETH RSL, MIT CSAIL, Stanford HAI, Boston Dynamics, Unitree, Pollen, 1X, Lex Fridman, Two Minute Papers, Yannic Kilcher and others)',
      '50-video curated catalog persists with promotion flags + 𝕏/LinkedIn social copy on 22 non-NVIDIA videos',
      '"Recent uploads" section now surfaces newly-published videos from tracked channels at the top of the Videos tab',
    ],
    gaps: [
      'Promotion still manual — even with the social copy ready to paste, no scheduler is actually posting',
      'Zero co-creation deals — 22 high-signal community creators flagged but no outreach',
      'View counts are pulled but not surfaced as deltas — we know absolute views, not which videos are accelerating',
    ],
    actions: [
      'Schedule 3 community creator video reposts this month using the auto-generated 𝕏 + LinkedIn copy (zero authoring cost — paste and post)',
      'Reach out to top 3 non-NVIDIA creators (ETH RSL, RoboticsDeveloper, Hugging Face) about co-branded tutorials with GPU credits',
...
const MONTHLY_SUMMARY = {
  month: 'May 2026',
  overallScore: 73,
  headline: 'Live data is flowing, the inventory is solid — now we need to act on it.',
  ...
  bigBets: [
    ...
    'Activate outreach on the 28 shouldEngage influencers — the watchlist exists, the pitches do not',
  ],
  quickWins: [
    'Merge the easiest 30 of the 241 stalled IsaacLab PRs this week — symbolic and practical signal to contributors',
    'Schedule 3 community video reposts using auto-generated 𝕏 + LinkedIn copy already in the dashboard (zero authoring cost)',
    'Send a co-amplification pitch to Chelsea Finn, Sergey Levine, and Jim Fan — top 3 by klout',
